...
+ [Code examples for EventBridge](service_code_examples.md)
   + [Cross-service examples for EventBridge](service_code_examples_cross-service.md)
      + [Use scheduled events to invoke a Lambda function](example_cross_LambdaScheduledEvents_section.md)
   + [Scenario examples for EventBridge](service_code_examples_scenario.md)
   ...
   + [API examples for EventBridge](service_code_examples_api.md)
