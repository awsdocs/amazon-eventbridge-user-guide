# Using EventBridge with an AWS SDK<a name="sdk-general-information-section"></a>
...
For examples specific to EventBridge, see [Code examples for EventBridge](service_code_examples.md)\.
