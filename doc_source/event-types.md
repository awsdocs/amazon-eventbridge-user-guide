# EventBridge Event Examples from Supported AWS Services<a name="event-types"></a>
...
+ [AWS Elastic Beanstalk Events](#elastic-beanstalk-event-types)
+ [Amazon EC2 Auto Scaling Events](#auto-scaling-event-types)
+ [Amazon EC2 Instance Rebalance Recommendation Events](#instance-rebalance-recommendation-event-types)
...
+ [AWS IoT Greengrass Events](#greengrass-event-types)
...
+ [Amazon Interactive Video Service \(IVS\) Events](#ivs-event-types)
+ [AWS KMS Events](#kms-event-types)
+ [Amazon Location Service events](#location-event-types)
+ [Amazon Macie Classic Events](#macie-classic-event-types)
+ [Amazon Macie Events](#macie-event-type)
+ [AWS Management Console Sign\-in Events](#console-event-type)
+ [AWS OpsWorks Stacks Events](#opsworks-event-types)
+ [SageMaker Events](#sagemaker-event-types)
+ [Savings Plans Events](#savingsplans-event-type)
...
## Amazon Augmented AI Events<a name="a2i-event-type"></a>
...
For sample events from CloudWatch, see [Alarm Events and EventBridge](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cloudwatch-and-eventbridge.html) in the *Amazon CloudWatch User Guide*\.
...
## AWS Elastic Beanstalk Events<a name="elastic-beanstalk-event-types"></a>

For information about the Elastic Beanstalk events, see [Using Elastic Beanstalk with Amazon EventBridge ](https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/AWSHowTo.eventbridge.html) in the *AWS Elastic Beanstalk Developer Guide*\.
...
## Amazon EC2 Instance Rebalance Recommendation Events<a name="instance-rebalance-recommendation-event-types"></a>

For information about the events for EC2 instance rebalance recommendations, see [Monitoring rebalance recommendation signals](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/rebalance-recommendations.html#monitor-rebalance-recommendations) in the *Amazon EC2 User Guide for Linux Instances*\.
...
## AWS IoT Greengrass Events<a name="greengrass-event-types"></a>

For information about AWS IoT Greengrass V1 events, see:
+ [Get Deployment Notifications](https://docs.aws.amazon.com/greengrass/latest/developerguide/deployment-notifications.html) in the *AWS IoT Greengrass V1 Developer Guide*\.
+ [Gathering system health telemetry data from AWS IoT Greengrass core devices](https://docs.aws.amazon.com/greengrass/v2/developerguide/telemetry.html) in the *AWS IoT Greengrass V1 Developer Guide*\.

For information about AWS IoT Greengrass V2 events, see:
+ [Gather system health telemetry data from AWS IoT Greengrass core devices](https://docs.aws.amazon.com/greengrass/v2/developerguide/telemetry.html) in the *AWS IoT Greengrass V2 Developer Guide*\.
...
## Amazon Interactive Video Service \(IVS\) Events<a name="ivs-event-types"></a>

For information about example Amazon IVS events, see [Using Amazon EventBridge with Amazon IVS](https://docs.aws.amazon.com/ivs/latest/userguide/SUE.html) in the *Amazon IVS User Guide*\.
...
## Amazon Location Service events<a name="location-event-types"></a>

For information about example Amazon Location Service events, see [Reacting to Amazon Location Service events with Amazon EventBridge](https://docs.aws.amazon.com/location/latest/developerguide/location-events.html)\.

## Amazon Macie Classic Events<a name="macie-classic-event-types"></a>

The following are examples of Amazon Macie Classic events\. 
...
## Amazon Macie Events<a name="macie-event-type"></a>

 For examples of events generated by Amazon Macie, see [Event schema for Amazon Macie findings\.](https://docs.aws.amazon.com/macie/latest/user/findings-publish-event-schemas.html) 
...
## SageMaker Events<a name="sagemaker-event-types"></a>

For information about example SageMaker events, see [Automating Amazon SageMaker with Amazon EventBridge](https://docs.aws.amazon.com/sagemaker/latest/dg/automating-sagemaker-with-eventbridge.html) in the *Amazon SageMaker Developer Guide*\.

## Savings Plans Events<a name="savingsplans-event-type"></a>

For examples of events generated by Savings Plans, see [Automating Savings Plans with Amazon EventBridge](https://docs.aws.amazon.com/savingsplans/latest/userguide/automating-savingsplans-with-eventbridge.html) in the *Savings Plans User Guide*\.
...
The following are examples of the events for AWS Systems Manager\. For more information, see [Monitoring Systems Manager events with Amazon EventBridge](https://docs.aws.amazon.com/systems-manager/latest/userguide/monitoring-eventbridge-events.html) in the *AWS Systems Manager User Guide*\.
