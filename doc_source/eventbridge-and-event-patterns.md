...
Events in Amazon EventBridge are represented as JSON objects\. For more information about JSON objects, see [RFC 7159](http://www.rfc-editor.org/rfc/rfc7159.txt)\. The following is an example event:
...
## Event Patterns<a name="eventbridge-event-patterns"></a>
