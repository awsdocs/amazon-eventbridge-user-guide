# EventBridge Permissions Reference<a name="permissions-reference-eventbridge"></a>
...
|  [ListTagsForResource](https://docs.aws.amazon.com/AmazonCloudWatchEvents/latest/APIReference/API_ListTagsForResource.html)  |  `events:ListTagsForResource` Required to list all tags associated with an EventBridge resource\. Currently, only rules can be tagged\.  | 
